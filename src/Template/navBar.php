  ...
  <div class="container-fluid">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body bg-dark">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link " href="/src/Views/listado.php">Listar Empleados </a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="ms-auto">
      ...
      <?php } else { ?>
        ...
        <a class="btn btn-danger" href="<?php echo dirname($_SERVER['PHP_SELF']) . 'src/Controllers/cerrarSesision.php'; ?>"><i class="bi bi-box-arrow-right"></i></a>
      <?php } ?>
    </div>
  </div>
</nav>
...
<?php
// Llamo al modal de loguin 
include_once("src/Components/modalLoguin.php");
?>
<?php
// Llamo al modal de registro
